...
@Component({
  selector: 'audits-body',
  templateUrl: './audits-body.component.html',
  styleUrls: ['./audits-body.component.scss']
})

export class AuditsBodyComponent extends BaseComponent implements OnInit, OnChanges, AfterViewInit {
  ...
  loadUsersActivities(filters: any = null): void {
    ...
    this.httpService.GET(UsersController.GetCurrentUserAudits, this.currentFilters)
      .subscribe(res => {
        console.log(res);
  ...
  loadUsersActivitiesForFirstTime(filters: any = null): void {
    this.httpService.GET(UsersController.GetCurrentUserAudits, filters)
      .subscribe(res => {
        console.log(res);
