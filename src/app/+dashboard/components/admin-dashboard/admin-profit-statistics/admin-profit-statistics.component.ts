...
@Component({
  selector: 'admin-profit-statistics',
  templateUrl: './admin-profit-statistics.component.html',
  styleUrls: ['./admin-profit-statistics.component.scss']
})
export class AdminProfitStatisticsComponent extends BaseComponent implements OnInit {
  splineAreaChart: any;
  series: any[] = [];
  years: any[] = [];
  vendors: any[] = [];
  ...
  ngOnInit(): void {
    ...
    this.loadData()
    this.loadVendorsDrp()
    this._splineAreaChart('[ "--vz-success"]');
  }
