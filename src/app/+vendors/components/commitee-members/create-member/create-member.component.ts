...
import { UsersValidator } from 'app/+vendors/validators/user.validator';
...
export class CreateMemberComponent extends BaseComponent implements OnInit {
  ...
  get url() {
    return this.role == RolesEnum.CommitteeMember ? MembersController.CreateCommitteeMember : MembersController.CreateVendorAdmin;
  }
