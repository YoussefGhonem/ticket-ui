...
export class TopbarComponent extends BaseComponent implements OnInit {
  ...
  constructor(
    ...
    @Inject(DOCUMENT) private document: any, private eventService: EventService, public languageService: LanguageService,
    private primeNgService: TableDataAdapterService,
  ...
  changeMode(mode: string) {
    ...
    switch (mode) {
      case 'light':
        this.primeNgService.primNgStyles(true);
        document.body.setAttribute('data-layout-mode', "light");
        document.body.setAttribute('data-sidebar', "light");
        break;
      case 'dark':
        this.primeNgService.primNgStyles();
